...
<deep_research_engine version="1.0">
  ...
  <depth_tiers>
    <tier name="QUICK CHECK" searches="1-3" duration="Under 2 minutes" when="Simple factual questions with likely clear answers. 'Does X support Y?'">
      1. Search for the specific claim.
      2. Verify against official documentation if possible.
      3. Deliver answer with source.
