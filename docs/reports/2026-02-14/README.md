...
**Audit Execution**: 2:08:01 PM, February 14, 2026
...
**Overall Compliance**: 58% (Baseline)
...
- `audit-2026-02-14T13-08-01-000Z.json` - Machine-readable full report
- `audit-2026-02-14T13-08-01-000Z.md` - Human-readable report
...
| ---------------------------- | ---------- | --------- | ---- |
| **Current Baseline**         | 58%        | -         | -    |
| **+ Security Issues**        | 59%        | 1 weeks   | LOW  |
...
**Audit ID:** `audit-2026-02-14T13-08-01-000Z`
**Timestamp:** February 14, 2026, 2:08:01 PM
