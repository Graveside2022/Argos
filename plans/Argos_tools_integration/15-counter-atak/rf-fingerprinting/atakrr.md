...
> **WARNING: NO WORKING CODE** - This project is in proposal stage only. The repository (github.com/ATAKRR/atakrr) contains only a README and design diagrams. Install instructions below are SPECULATIVE and will not produce a working system.
