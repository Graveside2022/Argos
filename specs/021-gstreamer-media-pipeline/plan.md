...
**Branch**: `021-gstreamer-media-pipeline` | **Date**: 2026-02-26 | **Spec**: [specs/021-gstreamer-media-pipeline/spec.md](spec.md)
**Input**: Feature specification from `/specs/021-gstreamer-media-pipeline/spec.md`
...
```text
specs/021-gstreamer-media-pipeline/
