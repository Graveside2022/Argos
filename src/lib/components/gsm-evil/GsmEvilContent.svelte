...
<script lang="ts">
	...
	} from '$lib/gsm-evil/page-logic';
	import { processScanStream } from '$lib/gsm-evil/scan-stream';
	import { hasCellInfo, toDetectedTower } from '$lib/gsm-evil/tower-helpers';
...
<style>
	@import '$lib/gsm-evil/gsm-evil-page.css';
</style>
