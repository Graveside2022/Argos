...
<div class="glass-panel rounded-xl p-6">
	...
	<div class="space-y-4">
		...
		<div class="flex items-center justify-between p-4 glass-panel-light rounded-lg">
			<div class="flex items-center space-x-3">
				<div
					class="status-indicator {$sweepStatus.active
						? 'status-connected'
						: 'status-disconnected'}"
				></div>
				<div>
		...
		<div class="flex items-center justify-between p-4 glass-panel-light rounded-lg">
			...
			<svg class="w-4 h-4 text-neon-green" fill="currentColor" viewBox="0 0 20 20">
				<path
					fill-rule="evenodd"
					d="M10 18a8 8 0 100-16 8 8 0 0016 0zm-2-3.82l-2.88-2.88a1 1 0 111.414-1.414L8 11.293l4.293-4.293a1 1 0 111.414 1.414L8 14.18z"
					clip-rule="evenodd"
				/>
			</svg>
		</div>
