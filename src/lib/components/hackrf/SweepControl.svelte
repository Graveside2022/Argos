...
<div class="glass-panel rounded-xl p-6">
	<h3 class="text-h4 font-heading font-semibold text-text-primary mb-6 flex items-center">
		<svg class="w-5 h-5 mr-2 text-accent-muted" fill="currentColor" viewBox="0 0 20 20">
			<path
				fill-rule="evenodd"
				d="M10 18a8 8 0 100-16 8 8 0 0016 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM12 10a1 1 0 100 2 1 1 0 000-2zm7 0a1 1 0 11-2 0 1 1 0 012 0z"
				clip-rule="evenodd"
			/>
		</svg>
		Sweep Control
	...
	<div class="mb-6">
		<label
			for="sweepCycleTime"
			class="block font-mono text-xs text-text-muted uppercase tracking-wider mb-2"
	...
	<div class="grid grid-cols-2 gap-4 mb-6">
		<div class="glass-panel-light rounded-lg p-4">
			...
			<p
				class="font-mono text-body {$sweepStatus.active
					? 'text-neon-green'
			...
			>
				...
				{:else}
					<svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
						<path
							fill-rule="evenodd"
							d="M10 18a8 8 0 100-16 8 8 0 0016 0zM9.555 7.168A1 1 0 008 8v4a1 1 0 001.555.832l3-2a1 1 0 000-1.664l-3-2z"
							clip-rule="evenodd"
						/>
					</svg>
					Start Sweep
				...
				{:else}
					<div class="flex items-center justify-center">
						<svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
							<path
								fill-rule="evenodd"
								d="M10 18a8 8 0 100-16 8 8 0 0016 0zM8 7a1 1 0 00-1 1v4a1 1 0 001 1h4a1 1 0 001-1V8a1 1 0 00-1-1H8z"
								clip-rule="evenodd"
							/>
						</svg>
						Stop Sweep
