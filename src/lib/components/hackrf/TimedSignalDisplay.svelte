...
<div class="glass-panel rounded-xl p-6 space-y-4">
	...
	<div class="flex items-center justify-between">
		<h3 class="text-h5 font-heading font-semibold text-text-primary flex items-center">
			<svg class="w-5 h-5 mr-2 text-neon-cyan" fill="currentColor" viewBox="0 0 20 20">
				...
				<path
					fill-rule="evenodd"
					d="M4 5a2 2 0 012-2 1 1 0 000 2H6a2 2 0 100 4h2a2 2 0 100 4h-2a1 1 0 100 2 2 2 0 01-2-2v-1a2 2 0 01-2-2V7a2 2 0 012-2h5a1 1 0 100-2H6a2 2 0 00-2 2z"
					clip-rule="evenodd"
				/>
			</svg>
			Live Signals
			...
			{#if showFading || !signal.isExpiring}
				<div
					...
					style="
						...
						background-color: rgba(28, 31, 38, {signal.opacity * 0.6});
					"
				>
					...
					<div class="relative flex items-center justify-between">
						...
						<div class="flex-1">
							<div class="flex items-center gap-3">
								...
								<span
									class="text-lg"
									style="color: {getAgeColor(
										(signal.age / signal.timeToLive) * 100
									)}"
								...
								<!-- Power -->
								<span
									class="font-mono text-sm {getSignalStrengthClass(signal.power)}"
								>
	...
	<!-- Footer stats -->
	<div
		class="flex items-center justify-between text-xs text-text-muted border-t border-border-primary pt-3"
	>
