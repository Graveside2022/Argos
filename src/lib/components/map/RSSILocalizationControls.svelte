...
<div class="rssi-controls">
	<div class="control-header">
		...
		{#if status.usingCoralTPU}
			<span class="coral-badge" title="Coral TPU Accelerated"> ⚡ TPU </span>
		{/if}
	</div>
	...
	{#if enabled}
		<div class="control-body">
			...
			{#if showDetails}
				<div class="details">
					<p>
						RSSI Localization estimates device positions based on signal strength
						measurements collected as the drone moves.
					</p>
					<p>Requirements:</p>
					<ul>
