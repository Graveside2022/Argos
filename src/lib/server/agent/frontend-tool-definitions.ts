/**
 * Frontend Tool Definitions for Agent UI Control
 *
 * Static registry of client-side tools the agent can invoke.
 * Each tool runs in the browser, not on the server.
 */
