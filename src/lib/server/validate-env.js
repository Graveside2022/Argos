...
console.log('[SEARCH] Validating environment variables...');

try {
  const env = envSchema.parse(process.env);
  console.log('[OK] Environment validation successful');
  ...
  console.error('\n[FIX] Please check your .env file and ensure all required variables are set correctly.\n');
