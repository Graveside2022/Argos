...
import { SignalInterpolator, type InterpolationMethod } from './signal-interpolation';
import { WebGLHeatmapRenderer } from './webgl-heatmap-renderer';
import { PerformanceMonitor } from './performance-monitor';
import type { GridCell } from './grid-processor';
...
export class HeatmapService {
	...
	processGridCells(
		...
		gridCells.forEach((cell) => {
			...
			if (
				cell.bounds.minLat >= bounds.minLat &&
